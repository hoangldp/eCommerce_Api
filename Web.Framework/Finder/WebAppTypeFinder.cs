...
namespace Web.Framework.Finder
{
    ...
    public class WebAppTypeFinder : AppDomainTypeFinder
    {
        ...
        public WebAppTypeFinder(ICoreFileProvider fileProvider, string libLoadingPattern) : base(fileProvider)
        {
            string pattern = ".*";
            if (!string.IsNullOrWhiteSpace(libLoadingPattern))
            {
                pattern = libLoadingPattern;
            }
