...
namespace Web.Framework.Finder
{
    /// <summary>
    /// IO functions using the on-disk file system
    /// </summary>
    public class WebFileProvider : PhysicalFileProvider, ICoreFileProvider
    {
        /// <summary>
        ...
        public WebFileProvider(IWebHostEnvironment webHostEnvironment)
            : base(string.IsNullOrEmpty(webHostEnvironment.WebRootPath) ? webHostEnvironment.ContentRootPath : webHostEnvironment.WebRootPath)
        {
